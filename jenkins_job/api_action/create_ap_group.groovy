...
# get zone_id
  ...
  # create ap_group
  for ap_group_name in `cat $VAR_DIR/input/ap_groups/$zone_name.inp`; do
    echo "start time:`date`"
    echo "$ap_group_name $zone_id"
    ./create_ap_group.sh $ap_group_name $zone_id | tee $VAR_DIR/output/ap_groups/${zone_name}_${ap_group_name}.out
    echo "end time:`date`"
  done
done
echo "end job:`date`"
